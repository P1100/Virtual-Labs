...
# );
#
# # GROUP is a reserved MySQL name!!
# create table `group`
# (
#     id bigint not null
#         primary key,
...
VALUES (12);
INSERT INTO virtuallabs.role (name)
VALUES ('ROLE_ADMIN');
INSERT INTO virtuallabs.role (name)
VALUES ('ROLE_GUEST');
INSERT INTO virtuallabs.role (name)
...
INSERT INTO virtuallabs.role (name)
VALUES ('ROLE_USER');
INSERT INTO virtuallabs.token (id, expiry_date, group_id, student_id)
...
INSERT INTO virtuallabs.group (id, name, status, course_id)
VALUES (11, 'Team0', 0, 'C0');
INSERT INTO virtuallabs.teams_students (group_id, student_id)
VALUES (11, '100');
INSERT INTO virtuallabs.teams_students (group_id, student_id)
VALUES (11, '101');
INSERT INTO virtuallabs.teams_students (group_id, student_id)
VALUES (11, 'S33');
INSERT INTO virtuallabs.user (username, account_non_expired, account_non_locked, credentials_non_expired, enabled, password)
...
INSERT INTO virtuallabs.users_roles (username, authority)
